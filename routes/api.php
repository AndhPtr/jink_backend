...
Route::prefix('page-content')->middleware('auth:sanctum')->group(function () {
...
Route::prefix('link-content')->middleware('auth:sanctum')->group(function () {
...
Route::prefix('text-content')->middleware('auth:sanctum')->group(function () {
...
Route::prefix('image-content')->middleware('auth:sanctum')->group(function () {
